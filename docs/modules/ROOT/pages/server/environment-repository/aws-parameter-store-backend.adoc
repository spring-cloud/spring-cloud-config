...
Spring Cloud Config Server supports AWS Parameter Store as a backend for configuration properties. You can enable this feature by adding a dependency to the https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/java_ssm_code_examples.html[AWS Java SDK for SSM].
...
AWS Parameter Store API credentials are determined using the https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/credentials-chain.html#credentials-default[Default Credential Provider Chain].
