...
If you include the right dependencies on the classpath (see https://docs.spring.io/spring-boot/reference/data/sql.html#data.sql.jdbc[the user guide] for more details on that), Spring Boot configures a data source.
