...
For instance, https://developer.github.com/v3/activity/events/types/#push[Github] uses a POST to the webhook with a JSON body containing a list of commits and a header (`X-Github-Event`) set to `push`.
