image::https://codecov.io/gh/spring-cloud/spring-cloud-config/branch/main/graph/badge.svg["Codecov", link="https://codecov.io/gh/spring-cloud/spring-cloud-config/branch/main"]
...
You can find a sample application https://github.com/spring-cloud/spring-cloud-config/tree/main/spring-cloud-config-sample[here].
