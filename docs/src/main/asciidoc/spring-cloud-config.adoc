...
TIP: The encrypted output when shown on console is obfuscated by adjacent 'Current Speed' value, redirecting the output to file helps avoid this confusion.

----
$ curl localhost:8888/encrypt -d mysecret > encrypted_secret.txt
----
