...
import org.springframework.cloud.context.scope.refresh.ProxyRefreshScopeIntegrationTests.TestConfiguration;
...
@Ignore
public class ProxyRefreshScopeIntegrationTests {
	...
	@Import({ RefreshAutoConfiguration.class, PropertyPlaceholderAutoConfiguration.class, ExampleService.class })
