...
public class ResourceController {
	...
	public String retrieve(@PathVariable String name, @PathVariable String profile, @PathVariable String label,
			ServletWebRequest request, @RequestParam(defaultValue = "true") boolean resolvePlaceholders,
						   @RequestHeader(value = HttpHeaders.ACCEPT_CHARSET, required = false, defaultValue = "UTF-8") String acceptedCharset)
			throws IOException {
	 ...
	 */
	String retrieve(String name, String profile, String label, String path, boolean resolvePlaceholders, String acceptedCharset)
			throws IOException {
