 ...
 * type of Git hosting service.
 *
 * <p>
 * Implementations are registered as optional Spring beans. The
 * {@link TransportConfigCallbackFactory} iterates through all available providers and
 * delegates to the first one that can handle the repository URI.
 */
public interface GitTransportConfigCallbackProvider {

	/**
	 * Returns {@code true} if this provider can handle the given properties.
