...
import org.springframework.cloud.config.server.environment.git.JGitEnvironmentRepositoryConcurrencyTests;
import org.springframework.cloud.config.server.environment.git.JGitEnvironmentRepositoryIntegrationTests;
import org.springframework.cloud.config.server.environment.git.JGitEnvironmentRepositoryTests;
import org.springframework.cloud.config.server.environment.JdbcEnvironmentRepositoryTests;
import org.springframework.cloud.config.server.environment.git.MultipleJGitEnvironmentApplicationPlaceholderRepositoryTests;
import org.springframework.cloud.config.server.environment.git.MultipleJGitEnvironmentLabelPlaceholderRepositoryTests;
import org.springframework.cloud.config.server.environment.git.MultipleJGitEnvironmentProfilePlaceholderRepositoryTests;
import org.springframework.cloud.config.server.environment.git.MultipleJGitEnvironmentRepositoryIntegrationTests;
import org.springframework.cloud.config.server.environment.git.MultipleJGitEnvironmentRepositoryTests;
